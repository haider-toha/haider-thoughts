...
export const blogPosts: BlogPost[] = [
  {
    id: "2",
    title: "The Living River of Mathematics",
    excerpt: "Mathematics is not a cold kingdom of eternal truths set apart from the world. It is a living river, flowing through cultures, carrying with it the sediments of survival and the light of transcendence. Ubiratan D’Ambrosio calls this current ethnomathematics, for mathematics is always shaped by the human hand, always marked by the earth from which it springs.",
...
The rhythm of survival and transcendence beat again in the invention of calculus. Newton and Leibniz, grappling with the mystery of motion, invoked infinitesimals, quantities smaller than any number yet greater than zero. They were ghosts, but ghosts with power. Berkeley mocked them as phantoms, but planets traced their orbits under their spell. It was Cauchy and Weierstrass who gave them clarity, defining limits with precision. To say $\\lim_{x \\to a} f(x) = L$ is to bind the elusive word “approaches” with the language of $\\epsilon$ and $\\delta$. For every $\\epsilon > 0$, there exists a $\\delta > 0$ such that whenever $|x-a| < \\delta$, then $|f(x)-L| < \\epsilon$. From this, the derivative and the integral arise, rigorous, unshakable, yet still rooted in that ancient desire to capture change itself.

And yet, mathematics also encounters its own horizons. In the twentieth century, Gödel showed that any system rich enough to contain arithmetic will harbor truths it cannot prove. His theorems revealed mathematics to be inexhaustible, forever incomplete. Far from diminishing it, this gave mathematics its most profound transcendence, for it revealed that the human quest for knowledge is infinite. Mathematics is not a closed book but an unfolding epic, a journey without end.

Even the mystics saw this. Sufi poets spoke of infinity as the face of the divine. To them, the boundless was not merely a number line stretching without end but the sign of what lies beyond all reckoning. When they spoke of unity and multiplicity, they echoed the mathematician’s struggle with the One and the Many, with the finite and the infinite. In their verses, the infinite was not abstract but intimate, the mirror of the soul’s longing.

To gather sheep with stones, to solve quadratics by completing the square, to trace the path of a planet with a circle within a circle, to define rigor with $\\epsilon$ and $\\delta$, to discover that truth itself will always exceed our grasp, these are not separate acts but one story. They are the human story of mathematics, rising from survival into transcendence. Al-Khwarizmi’s equations, Khayyam’s curves, Al-Tusi’s couples, Ibn al-Haytham’s rays, Peano’s axioms, Weierstrass’s limits, and Gödel’s theorems are chapters in a single book we are still writing. To study mathematics is to walk this path, to trace the footprints of shepherds, philosophers, and poets, and to add our own. It is to glimpse, in the language of number and proof, the unending effort of a species not content to survive but always reaching beyond, seeking in the finite symbols of mathematics a reflection of the infinite.`,
    date: "September 21, 2025",
    readTime: "12 min read",
    category: "Mathematics",
    slug: "The-Living-River-of-Mathematics",
  },
  {
    id: "1",
...
This question, however, is more complex than it first appears. Human traditions have long wrestled with the paradox of desire. Is desire the fire that drives growth, or the chain that binds us to perpetual dissatisfaction? The <a href="https://en.wikipedia.org/wiki/Stoicism" target="_blank" rel="noopener noreferrer">Stoics</a> taught that true freedom lies in limiting one’s wants to what lies within one’s control. <a href="https://en.wikipedia.org/wiki/Buddhism" target="_blank" rel="noopener noreferrer">Buddhism</a>, in its most well-known teaching, identified craving as the root of suffering. And yet, to reduce this entire discussion to the dichotomy of East and West, or to figures like Buddha and Socrates, would be to overlook a profound and deeply textured tradition within <a href="https://en.wikipedia.org/wiki/Islamic_philosophy" target="_blank" rel="noopener noreferrer">Islamic philosophy</a>, where thinkers sought not only to critique desire but to map its anatomy.

Among these thinkers, <a href="https://en.wikipedia.org/wiki/Al-Ghazali" target="_blank" rel="noopener noreferrer">Al-Ghazali</a> stands out. For Al-Ghazali, the problem was never simply desire itself, but its origin and its destination. Where does my longing arise from? Toward what end does it pull me? Desire can be a ladder to transcendence or a pit that swallows us whole. The issue, then, is not to kill desire but to purify it, to transmute its energy so it ceases to serve the lower self and begins to serve the higher.

Consider, the famous encounter between <a href="https://en.wikipedia.org/wiki/Alexander_the_Great" target="_blank" rel="noopener noreferrer">Alexander the Great</a> and <a href="https://en.wikipedia.org/wiki/Diogenes" target="_blank" rel="noopener noreferrer">Diogenes the Cynic</a>. On the one hand stands Alexander, embodiment of conquest, power and restless striving. He personifies what Islamic thought would call the <a href="https://en.wikipedia.org/wiki/Nafs" target="_blank" rel="noopener noreferrer">nafs al-ammārah</a>, the commanding soul, driven by appetite and ambition without restraint. On the other hand sits Diogenes, dwelling in his barrel, embodying radical detachment from society’s norms and possessions. To many, his life appeared absurd; to him, it was freedom.
...
For others, however, low desire signals a very different reality. It may arise from kasal (sloth), jubn (cowardice), or sheer despair. This is the artist who never paints, not because she has transcended ambition but because she fears failure. This is the would-be leader who never speaks, not out of humility but out of self-doubt. Here, low desire is a prison. The Persian poet <a href="https://en.wikipedia.org/wiki/Rumi" target="_blank" rel="noopener noreferrer">Rumi</a> warns against this false quiet. It is not peace but betrayal, the silencing of the soul’s call. In such a state, the soul suffers not because it craves too much, but because it denies its own God-given potential, its Fitrah.
